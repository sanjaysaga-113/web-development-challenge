document.addEventListener('DOMContentLoaded', () => {
  ...
  // Function to search menu by title and description
  function searchMenu() {
  ...
  function updateButtonState(activeCategory) {
    filterButtons.forEach(button => {
      button.classList.toggle('clicked', button.dataset.category === activeCategory);
    });
  }
  ...
  document.querySelector('.button1').addEventListener('click', () => filterMenu('all'));
  document.querySelector('.button2').addEventListener('click', () => filterMenu('starters'));
  document.querySelector('.button3').addEventListener('click', () => filterMenu('mains'));
  document.querySelector('.button4').addEventListener('click', () => filterMenu('desserts'));
  document.querySelector('.button5').addEventListener('click', () => filterMenu('beverages'));
